...
public class MimikaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_mimika, container, false);


        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) CircleImageView mashq2 = view.findViewById(R.id.mashq1_m);
