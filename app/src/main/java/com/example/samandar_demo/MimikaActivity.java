...
public class MimikaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.videoView_m);
        surfaceView = findViewById(R.id.surface_view_m);
    ...
    private void openCamera() {
        SurfaceView surfaceView = findViewById(R.id.surface_view_m);
    ...
    private void playVideo() {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.emotsiyalar; // R.raw.video_resource video manzili
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mediaPlayer) {
                ...
                timer.schedule(new TimerTask() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(MimikaActivity.this , Succes.class);
                        startActivity(intent);
                        Animatoo.INSTANCE.animateDiagonal(MimikaActivity.this);
                        // Musiqani boshlash
                        mediaPlayer.start();
                        finish();
                    }
